  ...
  <div class="row">
        <div class="col-xl-6 col-md-6">
					<div class="card bg-primary text-white mb-4">
						<div class="card-body"><i class="fa fa-tasks"></i> Staff</div>
						<div class="card-footer d-flex align-items-center justify-content-between pointer viewAllSchedule">
							<a class="small text-white stretched-link" href="<?php echo URLROOT;?>/Installations/staff" >View Details</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-left actionDropdown" aria-labelledby="userDropdown">
                              <a class="dropdown-item updateLevel pointer" id="<?php echo $row->userId ?>" ><i class = "fa fa-key"></i> level</a>
                                ...
                                <!-- <a class="dropdown-item" href="<?php //echo URLROOT;?>/guests/logout"> <i class="fa fa-sign-in"></i> Logout</a> -->
                            </div>
                        </li>
                    </ul>
                  </div>
    ...
    <div class="modal-content panel panel-default">
      ...
      <div class="modal-body">
        ...
        <select type="text" name="group" id="edatS" placeholder="Address" class="form-control form-control-sm " >
          ...
          <option  >head Project Management</option>
