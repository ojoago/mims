<?php
  ...
  if(isset($_POST['export'])){
    ...
    foreach($data['sr_cn'] as $cell){
      ...
      $active_sheet->setCellValue('E'.$k,$cell->old-$cell->quantity);
    ...
    $path= 'sr-cn_'.rand(9,999).'.xlsx';
    $writer = new Xlsx($file);
    $writer->save($path);
    if(extension_loaded('zip')){
      $zip = new ZipArchive();
      $zipName = "sr-cn-".rand(1,1000).".zip";
          ...
          <div class="card card-body  mt-1">
            <div class="card-header">
                <form method="post" style="margin:0;" class="mx-auto mt-0">
                  <i class="fas fa-table mr-1"></i>SR-CN
                  <a href="<?php echo URLROOT ?>/stores/sr_cn">
            ...
            <form method="post" id="bydateRange" class="Filter" style="display:none" class="mx-auto mt-0">
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover small" width="100%">
                  ...
                  <tbody>
                <?php $n=0; foreach($data['sr_cn'] as $row) :?>
                   <tr class="small">
                   <!-- <td><php echo ++$n?></td> -->
                   ...
                   <!-- <td >< echo row->old></td> -->
                   <td ><?php echo ($row->old-$row->quantity)?></td>
