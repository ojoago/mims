          ...
          <div class="card card-body">
            <div class="row">
              ...
              <div class="col-md-6 col-lg-6 col-xl-6">
                ...
                <select type="text"  id="toStore" name="to" class = "form-control form-control-sm select2 " >
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#toStore').change(function(){
      if($('#category').val()!=null){
        var id=$(this).val();
        if($('#category').val().toUpperCase()=='SR-IN'){
          $.ajax({
            url:"<?php echo URLROOT?>/helpers/dropdown.php",
            type:"POST",
            dataType:"json",
            data:{loadAllStoreItems:true,id:id},
    ...
    $(document).on('change','#itemsName',function(){
      var id =$(this).val();
      $.ajax({
