...
<div class="card">
  <div class="card-header">
    <form method="post" style="margin:0;" class="mx-auto mt-0">
      ...
      <a href="<?php echo URLROOT ?>/stores"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Refresh" > <i class="fa fa-spinner fa-spin"></i> </button></a>
