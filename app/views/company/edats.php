              ...
              <?php $n=0; foreach($data['cust'] as $row) :?>
                <?php  $e=countMeters($row->eid);?>
                 ...
                 <td>
                   ...
                   <?php if(strtolower($row->edatstatus)!='installed'): ?>
                 ...
                 <?php elseif(strtolower($row->edatstatus)=='faulty'): ?>
                    <i class="fa fa-forward fixedat text-primary pointer" data-toggle="tooltip" data-placement="top" title="fix" id="<?=$row->eid ?>" ></i>
                   <?php endif; ?>
                 </td>
                 ...
                 <td><img class = "img img-responsive small img-small" src="<?php echo URLROOT?>/images/<?php echo $row->edatfoto ?>"></td>
    ...
    <div class="modal-content panel panel-default">
      ...
      <div class="modal-body">
        <!-- <div class = "form-group"> -->
          <span id="required" class="text-danger required"></span>
      ...
      <div class="modal-footer">
					<button  class="btn btn-primary pull-left btn-sm" name="asignBtn" id="asignEdatBtn"><i class="fa cog"></i> Go</button>
