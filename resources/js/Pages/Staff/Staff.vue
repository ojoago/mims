           ...
           <div class="px-4 py-2">
            <form >
                            ...
                            <div class="grid grid-cols-3 gap-4 py-4 px-4 md:py-8 md:px-8 text-sm">
                                ...
                                <div class="flex flex-col ">
                                        <BaseSelect label="Select Gender" v-model="staffForm.gender" :selected="staffForm.gender" :options="genders" />
                                ...
                                <div class="flex flex-col ">
                                    <BaseSelect label="LGA of Origin" v-model="staffForm.lga_of_origin" :selected="staffForm.lga_of_origin" :options="origin_lgas" />
                                    <InputError class="mt-2" :message="staffForm.errors.lga_of_origin" />   
                                </div>
                                <div class="flex flex-col ">
                                    <BaseSelect label="Staff Role" v-model="staffForm.role" :selected="staffForm.role" :options="roles" />
